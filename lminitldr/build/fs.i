...
fhdsc_t* get_fileinfo(char_t* fname,machbstart_t* mbsp)
{
    ...
    mlosrddsc_t* mrddadrs=(mlosrddsc_t*)((u32_t)(mbsp->mb_lmosimgpadr+(0x1000)));
...
int move_krlimg(machbstart_t* mbsp,u64_t cpyadr,u64_t cpysz)
{
    ...
    void* toadr=(void*)((u32_t)((((cpyadr+cpysz) + (0x1000) - 1) & ~((0x1000) - 1))));
...
void init_krlfile(machbstart_t* mbsp)
{
    u64_t sz=r_file_to_padr(mbsp,0x2000000,"lmosemkrnl.bin");
    if(0==sz)
    {
        kerror("ik_rfilepadr err");
    }
    mbsp->mb_krlimgpadr=0x2000000;
    mbsp->mb_krlsz=sz;
    mbsp->mb_nextwtpadr=(((mbsp->mb_krlimgpadr+mbsp->mb_krlsz) + (0x1000) - 1) & ~((0x1000) - 1));
...
void init_defutfont(machbstart_t *mbsp)
{
    ...
    mbsp->mb_bfontsz=sz;
    mbsp->mb_nextwtpadr=((((u32_t)(dfadr)+sz) + (0x1000) - 1) & ~((0x1000) - 1));
...
u64_t get_wt_lmosimgfilesz(machbstart_t* mbsp)
{
    u64_t retsz=0x4000000;
    mlosrddsc_t* mrddadrs=(mlosrddsc_t*)(0x4000000 +0x1000);
    if(mrddadrs->mdc_endgic!=0xaaffaaffaaffaaff||
            mrddadrs->mdc_rv!=0xffaaffaaffaaffaa||
            mrddadrs->mdc_fhdnr<2||
            mrddadrs->mdc_filnr<2)
...
u64_t r_file_to_padr(machbstart_t* mbsp,u32_t f2adr,char_t* fnm)
{
    ...
    if(0==chk_memsize((e820map_t*)((u32_t)mbsp->mb_e820padr),(u32_t)(mbsp->mb_e820nr),f2adr,sz))
    {
        return 0;
    }
...
void* read_sector(u64_t sector)
{
    set_rwhdhdpack((rwhdpach_t*)(0x2000 +32),1,0x3000,0,(((u32_t)sector)),(u32_t)(sector>>32));
    realadr_call_entry((1*2),0,0);
    return (void*)0x3000;
}
