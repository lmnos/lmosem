...
void write_realintsvefile()
{
    ...
    m2mcopy((void*)((u32_t)(fhdscstart->fhd_intsfsoff)+0x4000000),
            (void*)0x1000,(sint_t)fhdscstart->fhd_frealsz);
...
fhdsc_t* find_file(char_t* fname)
{
    ...
    s64_t rethn=-1;
    fhdsc_t* fhdscstart=(fhdsc_t*)((u32_t)(mrddadrs->mdc_fhdbk_s)+0x4000000);
...
void write_ldrkrlfile()
{
    ...
    m2mcopy((void*)((u32_t)(fhdscstart->fhd_intsfsoff)+0x4000000),
            (void*)0x200000,(sint_t)fhdscstart->fhd_frealsz);

    return;
}
# 94 "../ldrkrl/inithead.c"
void error(char_t* estr)
{
